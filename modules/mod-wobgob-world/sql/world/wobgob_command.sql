...
CREATE TABLE `command` (
  ...
  `help` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
('account create',1,'Syntax: .account create $account $password\r\n\r\nCreate account and set password to it.'),
...
('character check bag',2,'Syntax: .character check bag [$target_player]\r\n #bagSlot 1 - 4'),
...
('combatstop',1,'Syntax: .combatstop [$playername]\r\nStop combat for selected character. If selected non-player then command applied to self. If $playername provided then attempt applied to online player $playername.'),
...
('debug send',3,NULL),
('debug send buyerror',3,NULL),
('debug send channelnotify',3,NULL),
('debug send chatmmessage',3,NULL),
('debug send equiperror',3,NULL),
('debug send largepacket',3,NULL),
('debug send opcode',3,NULL),
('debug send qinvalidmsg',3,NULL),
('debug send qpartymsg',3,NULL),
('debug send sellerror',3,NULL),
('debug send setphaseshift',3,NULL),
('debug send spellfail',3,NULL),
('debug setaurastate',3,NULL),
('debug setbit',3,NULL),
('debug setitemvalue',3,'Syntax:'),
('debug setvalue',3,NULL),
('debug setvid',3,NULL),
('debug spawnvehicle',3,NULL),
...
('guild info',3,'Shows information about the target\'s guild or a given Guild Id or Name.'),
...
('modify arenapoints',3,'Syntax: .modify arenapoints #value\r\nAdd $amount arena points to the selected player.'),
...
('playall',3,'Syntax: .playall #soundid\r\n\r\nPlay a sound to whole server.'),
('player learn',3,'Syntax: .player learn #playername #spell [all].'),
('player unlearn',3,'Syntax: .player unlearn #playername #spell [all].'),
...
('reload dungeon_access_template',3,'Syntax: .reload dungeon_access_template\r\n Reload dungeon_access_template table.'),
...
('spect leave',0,NULL),
('spect reset',0,NULL),
('spect spectate',0,NULL),
('spect version',0,NULL),
('spect watch',0,NULL),
...
('teleport group',1,'Syntax: .teleport group#location\r\nTeleport a selected player and his group members to a given location.'),
('teleport name',1,'Syntax: .teleport name [#playername] #location\r\nTeleport the given character to a given location. Character can be offline.\r\nTo teleport to homebind, set #location to \"$home\" (without quotes).'),
...
('ticket response',1,'Syntax:'),
('ticket response append',1,'Syntax:'),
('ticket response appendln',1,'Syntax:'),
...
('reload dungeon_access_requirements',3,'Syntax: .reload dungeon_access_requirements\r\n Reload dungeon_access_requirements table.'),
...
('item restore',2,'Syntax: .item restore [#recoveryItemId] [#playername]\r\n\r\nRestore a disposed item for the specified player. Get recoveryId from \".item restore list\" command.'),
...
('guild rename',3,'Syntax: .guild rename \"$GuildName\" \"$NewGuildName\" \r\n\r\n Rename a guild named $GuildName with $NewGuildName. Guild name and new guild name must be in quotes.'),
...
('cfbg race',0,'Morphs your character to the selected race once you join a battleground.\nBy default, the following races are available: human, dwarf, gnome, draenei (\"broken ones\"),
 orc, bloodelf, troll, tauren.'),
